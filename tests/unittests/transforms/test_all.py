...
def test_all_configs():
    ...
    for name in dir(config_module):
        ...
        if inspect.isclass(cls):
            ...
            assert (
                cls._get_name() in [transform for transform in ZooTransform]
...
def test_all_transforms():
    ...
    for name in dir(transforms_module):
        ...
        if inspect.isclass(cls):
            ...
            assert (
                name in [transform for transform in ZooTransform]
            ...
            assert (
                sig.return_annotation is DataPoint
